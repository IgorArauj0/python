...
print("Planilhas de alunos aprovados e reprovados foram criadas com sucesso!")
...
print("Total de alunos reprovados:", len(alunos_reprovados))

print("\nDeseja visualizar os alunos aprovados ou reprovados? (Digite 'aprovados' ou 'reprovados')")
